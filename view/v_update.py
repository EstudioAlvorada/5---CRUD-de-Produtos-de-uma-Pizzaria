...
class tela_update:
    def chamaTelaUpdate(self):
        ...
        # Titulo da janela
        lb0 = Label(janela, text="Update - Atualizar") ; lb0.grid(row=0, column=0) ; lb0.place(x=0, y=135)
        ...
        janela.title("Pizzaria Top - CRUD Produtos - Atualizar")
